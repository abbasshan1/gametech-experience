(function () {
    ...
    function openAI() {
        ...
        // Wait one frame so the injected DOM (#gtChat, #gtConsultationActions) is fully available
        requestAnimationFrame(() => {
            startGTBuildConsultation();
            // Make sure the consultation UI is visible inside the scrollable workspace
